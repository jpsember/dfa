...
public class TokenDefinitionParser {
  ...
  private NFA parseCONCAT() {
    ...
    if (hasNext() && !peekIs(T_TOKENID, T_ALTERNATE, T_PARCL, T_MINUS)) {
      NFA e2 = parseCONCAT();
...
//    throw badArg("Parse exception;", BasePrinter.toString(msgs), ":", s, mOrigLineNumber, mOrigScript);
  ...
  public static final int T_TOKENID = 9;
  public static final int T_ZERO_OR_MORE = 10;
  public static final int T_ZERO_OR_ONE = 11;
  public static final int T_ONE_OR_MORE = 12;
  public static final int T_ALTERNATE = 13;
  public static final int T_RANGE = 14;
  public static final int T_HEXVALUE = 15;
  public static final int T_OTHER_ESCAPE_SEQ = 16;
  public static final int T_WORD_CHAR = 17;
  public static final int T_DIGIT_CHAR = 18;
  public static final int T_FORMFEED = 19;
  public static final int T_CARRIAGERET = 20;
  public static final int T_SPACE = 21;
  public static final int T_TAB = 22;
  public static final int T_NEWLINE = 23;
  public static final int T_ASCII = 24;
